...
@Command(label = {"embed", "message"}, usage = "embed {hex} {message}", minArgs = 2, permission = Permission.ADMINISTRATOR, description = "Sends an embed with the text and hex colour", hideInHelp = true)
